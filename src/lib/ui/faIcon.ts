...
import { registerAsset, registerInsert } from "../core/store.ts";

export type IconType = "brands" | "solid";

export type BrandsIconName = (typeof brands_icons)[number];
...
export type SolidIconName = (typeof solid_icons)[number];
...
export type FAIcon = BrandsIcon | SolidIcon;

export function faIcon(store: Store): ComponentFn<FAIcon> {
